...
```bash
cmake -S clarisweep -B clarisweep/build
cmake --build clarisweep/build -j4
ctest --test-dir clarisweep/build --output-on-failure
QT_QPA_PLATFORM=offscreen clarisweep/build/clarisweep --verify
```
